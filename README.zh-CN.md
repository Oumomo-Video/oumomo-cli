...
<p align="center">
  在终端里，把验证过能出单的爆款 TikTok 复刻成你自己的商品视频。
  <br/>为 TikTok Shop 跨境电商卖家而生。
</p>
...
你肯定刷到过别人家那条爆款带货视频——钩子、节奏、CTA 全都踩对了。找达人翻拍一条几百上千，普通 AI 视频工具给你的是一段没人会点开的产品旋转展示。

Oumomo 的做法是：把那条**已经被市场验证过**的视频，换成**你的**商品重新生成——同样的转化结构，你的素材、你的卖点。对话由 Agent 主导，`oumomo-agent` 负责安全登录、商品图上传、调用 Oumomo 工具以及所有付费操作前的显式确认。它是零生产依赖的瘦客户端，不分发 Oumomo 的模型、提示词、适配器或智能体运行时。
...
- **复刻能转化的结构** — 把验证过的爆款结构围绕你的商品重建，产出可直接投 TikTok Shop 的视频。
